...
function renderProjectPage(project, slug) {
    ...
    const url = `https://lunix.is-a.dev/${slug}`;
...
<head>
    ...
    <!-- Extra Meta Tags -->
    <meta name="theme-color" content="${escapeHtml(project.color || '#cc1b1b')}">
    <meta name="robots" content="noindex, follow">

    <!-- Open Graph -->
    <meta property="og:title" content="Lunix | ${title}" />
    <meta property="og:description" content="${ogDesc}" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="${url}" />
    <meta property="og:image" content="https://lunix.is-a.dev/images/og-preview.png" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="Lunix | ${title}" />
    <meta name="twitter:description" content="${ogDesc}" />
    <meta name="twitter:image" content="https://lunix.is-a.dev/images/og-preview.png" />
...
<body>
    ...
    <header class="header">
        <div class="logo">
            <a href="/" class="brand-mark" aria-label="Lunix home">
                <span class="brand-prompt">&gt;_</span><span class="brand-name">Lunix</span>
            </a>
        </div>
...
${aboutParagraphsHtml}
    ...
    <footer class="footer">
        <p>© ${new Date().getFullYear()} Lunix</p>
    </footer>
